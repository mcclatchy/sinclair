...
$.fn.byline = function(input) {
	...
	selector.append('<aside class="byline center"><small class="b-name upper ral fat block">By '
	+input.name+
	'</small><a href="mailto:'+input.email+'"class="b-email upper ral normal small block">'
	+input.email+
...
$(this).after('<div class="photo-array double-wide"><figure class="left float-left"><img src="'
	+input.firstPhotoUrl+
	'"alt="'
	+input.Caption+
	'"/></figure><figure class="right"><img src="'+input.secondPhotoUrl+'" alt="'+input.Caption+'"/></figure><div class="clearfix"></div><small class="photo-credit xsmall upper ral normal right">'
	+input.Credit+
	'</small><figcaption>'
	+input.Caption
	+'</figcaption></div>');
